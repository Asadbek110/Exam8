...
from core.models import Category, Product, Comment, Attribute, AttributeValue, ProductAttribute
from core.serializers import ProductModelSerializer, CategoryModelSerializer, CategoryDetailModelSerializer, \
